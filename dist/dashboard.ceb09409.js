...
})({"5qY6Q":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "e16b1269ceb09409";
"use strict";
...
},{}],"7KQzc":[function(require,module,exports) {
"use strict";
...
const amount = 100000;
const userName = document.querySelector(".account-name").textContent = user.name;
const cardName = document.querySelector(".cardName").textContent = user.name;
const welcome = document.querySelector(".welcome").textContent = `welcome back ${user.name}`;
const accountNumber = document.querySelector(".acc-no").textContent = user.accountNumber;
const balance = document.querySelector(".balance").textContent = `$ ${amount}`;
...
},{}]},["5qY6Q","7KQzc"], "7KQzc", "parcelRequire34f3")

//# sourceMappingURL=dashboard.ceb09409.js.map
